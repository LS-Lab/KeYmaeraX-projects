#!/bin/sh
cat lics1-continuous-forward.kya lics2-hybrid-forward.kya  lics4a-time-safe.kya bouncing-ball.kya rotational.kya damposc.kya exp.kya ../dlds/parachute.kya > dlds.kya 
